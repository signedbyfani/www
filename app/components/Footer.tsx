...
const Footer = () => {
  ...
  return (
    <footer className="max-w-[700px] mx-auto mb-16 animate-in p-5 sm:p-4 fade-in-0 duration-300">
      <div className="border border-secondary bg-secondary rounded-3xl px-4 py-12 sm:px-6 lg:px-8">
